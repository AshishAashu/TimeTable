...
public class savetable extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        File thetimetabledir=new File("C:\\Users\\AshishAashu\\Desktop\\TimeTable");
        if(!thetimetabledir.exists()){
            try{
                thetimetabledir.mkdir();
            }catch(Exception e){System.out.println(e);}
        }
        File theteacherchartdir=new File("C:\\Users\\AshishAashu\\Desktop\\TimeTable\\TeacherChart");
        if(!theteacherchartdir.exists()){
            try{
                theteacherchartdir.mkdir();
            }catch(Exception e){System.out.println(e);}
        }
        File themasterchartdir=new File("C:\\Users\\AshishAashu\\Desktop\\TimeTable\\MasterChart");
        if(!themasterchartdir.exists()){
            try{
                themasterchartdir.mkdir();
            }catch(Exception e){System.out.println(e);}
        }
        File theclasschartdir=new File("C:\\Users\\AshishAashu\\Desktop\\TimeTable\\ClassRoomChart");
        if(!theclasschartdir.exists()){
            try{
                theclasschartdir.mkdir();
            }catch(Exception e){System.out.println(e);}
        }
        ...
        ArrayList<Courses> courses=bean.getA();
        /*for(int m=0;m<6;m++){
            for(int n=0;n<7;n++){
        ...
        for(Courses course:courses){
            wb=Workbook.createWorkbook(new File("C:\\Users\\AshishAashu\\Desktop\\TimeTable\\MasterChart\\"+course.brname+course.year+"TimeTable.xls"));
        ...
        for(int m=0;m<6;m++){
            for(int n=0;n<7;n++){
                if(course.coursetable[m][n]==null)
                    excelSheet.addCell(new Label(n+1,m+1,"--------------",wcf));
                else
                excelSheet.addCell(new Label(n+1,m+1,course.coursetable[m][n],wcf));
            } 
        }
